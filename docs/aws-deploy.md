...
- Calendar Heatmap, Today Publish Count, Publish Rate, Publish Action Trend, API Activity, Top Updated Contents, Average Time to Publish by API, Average Draft to Publish by API の 8 パネルが plugin / datasource error にならない
