...
- Calendar Heatmap, Today Publish Count, Published State Rate, API Activity, Publish Action Trend, Top Updated Contents, Average Time to Publish by API, Average Draft to Publish by API の 8 パネルが plugin / datasource error にならない
